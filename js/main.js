...
$(function() {
  ...
  var bar = new ProgressBar.Line(lineprog300, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3000,
  ...
  var bar = new ProgressBar.Line(lineprog30, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3000,
  ...
  var bar = new ProgressBar.Line(lineprog301, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3000,
  ...
  var bar = new ProgressBar.Line(lineprog40, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3100,
  ...
  // reinit
  document.addEventListener("swup:contentReplaced", function(e) {
   // console.log('eee',e);
    Scrollbar.use(OverscrollPlugin);
    Scrollbar.init(document.querySelector('#scrollbar'), {
      damping: 0.05,
